...
export default function SectionOne() {
  return (
    <section className='w-full relative h-svh flex justify-content-center items-center'>
        <Pc />

        <div className="flex flex-col justify-content-center items-start absolute bottom-0 left-0 pb-10 pl-5 gap-6 md:gap-7">
