...
export default function SectionThree({observe, isActive}) {
  return (
    <section ref={observe} className="w-full relative h-svh snap-start flex justify-content-center items-center flex-col md:flex-row bg-black text-white px-5 md:gap-5">
