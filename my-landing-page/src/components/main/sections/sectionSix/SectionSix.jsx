...
export default function SectionSix() {
  ...
  return (
    <section className="w-full h-svh flex justify-between items-center flex-col md:flex-row p-5  md:gap-8">
      <div className="flex flex-col justify-around items-center h-full">
        <h3 className="text-start text-6xl md:text-7xl font-bold font-mono">My projects</h3>
