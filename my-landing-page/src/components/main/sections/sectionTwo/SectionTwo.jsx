...
export default function SectionTwo() {
  return (
    <section className="w-full h-svh flex justify-between items-center flex-col md:flex-row p-5  md:gap-8 bg-black">
      <figure className="w-[300px] h-[300px] md:w-[300px] md:h-[400px] lg:w-[500px] lg:h-[500px] p-0 m-0 flex-shrink-0">
        <img
      ...
      <div className="flex flex-col justify-center items-start gap-3 text-left px-2 md:px-0 ">
        ...
        <button className="rounded-none bg-[#9B9B9B] text-white p-3 hover:bg-[#6B6B6B] transition-colors duration-300">
